                                            ...
                                            <tr>
                                                <td><input type="radio" name="bank" id="bank20" value=""
                                                           class="bankicon"/><label for="bank20"><img
                                                                src="${ctx}/static/images/bank/bank20.gif" width="96"
                                                                height="32"
                                                                alt=""/></label></td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        ...
                        <td class="summary">
                                ...
                                <table class="ddbox" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="" value="" id="" class="stext f-l"
                                                   style="width:227px;"/><a style="margin-left:10px;display:inline;"
                                                                            class="f-l" href="#"><img
                                                        src="${ctx}/static/images/shiyong.gif" width="62" height="24"
                                                        alt="使用"/></a>
                                            <div class="clear"></div>
                                    ...
                                    <tr>
                                        <td align="right"><input type="checkbox" name="" id="thispl" value=""/> <label
                                                    for="thispl"><img src="${ctx}/static/images/lpicon.gif"/></label>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="f-r" style="width:170px;padding:0 15px;background:#f3f3f3;">
                                <form action="${ctx}/order/submitOrder" method="get">
                                    <table class="totable" width="100%">
                                        ...
                                        <tr>
                                            <td align="right" colspan="2"><input type="submit" name="" id="" value=""
                                                                                 class="btnimg"/></td>
                                        </tr>
                                        <tr>
                                            <td height="10px"></td>
